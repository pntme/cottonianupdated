(function() {
    ...
    function googleLogin($http, $q, $interval, $log, timeStorage,configuration, $ionicLoading) {
        var service = {};
        service.access_token = false;
        service.redirect_url = configuration.googleRedirecturl;
        service.client_id = configuration.googleClientId;
        service.secret = configuration.googleSecret;
        service.scope = configuration.googleScope; 
